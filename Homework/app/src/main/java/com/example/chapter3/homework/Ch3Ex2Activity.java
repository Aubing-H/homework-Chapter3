...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        int myDuration = Integer.parseInt(durationSelector.getText().toString());
        ...
        animator1.setDuration(myDuration);
        ...
        animatorSet.playTogether(animator1, scaleXAnimator, scaleYAnimator);
        animatorSet.start();
    }
}
